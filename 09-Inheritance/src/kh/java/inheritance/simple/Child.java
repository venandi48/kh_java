 ...
 * 
 * Parent의 멤버(필드, 메소드)를 선언 없이 Child에서 상속받아 사용가능
 * 
 * 특징
 * 1. 부모클래스의 필드, 메소드를 선언 없이 사용가능
 * 2. 하나의 부모클래스만 상속가능 (단일상속)
 ...
 * 5. 부모클래스의 private 필드는 상속받더라도 직접 접근할 수 없다.
 * 	- public메소드
 * 	- super() 부모생성자 호출 시 값전달
 * 
 */
